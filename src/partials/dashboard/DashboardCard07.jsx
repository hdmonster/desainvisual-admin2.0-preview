          ...
          <table className='table-auto w-full'>
            ...
            <thead className='text-xs uppercase text-slate-400 bg-slate-50 rounded-sm'>
              <tr>
                ...
                <th className='p-2'>
                  <div className='font-semibold text-center'>Followers</div>
                </th>
                {/* <th className='p-2'>
            ...
            <tbody className='text-sm font-medium divide-y divide-slate-100'>
              ...
              <tr>
                ...
                <td className='p-2'>
                  <div className='text-center text-green-500'>+40%</div>
                </td>
                {/* <td className='p-2'>
                  <div className='text-center'>267</div>
                </td> */}
                <td className='p-2'>
                  <div className='text-center text-sky-500'>+4700%</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                ...
                <td className='p-2'>
                  <div className='text-center text-green-500'>+36%</div>
                </td>
                {/* <td className='p-2'>
                  <div className='text-center'>249</div>
                </td> */}
                <td className='p-2'>
                  <div className='text-center text-sky-500'>+1200%</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                ...
                <td className='p-2'>
                  <div className='text-center text-sky-500'>+800%</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                ...
                <td className='p-2'>
                  <div className='text-center text-green-500'>+22%</div>
                </td>
                {/* <td className='p-2'>
                  <div className='text-center'>220</div>
                </td> */}
                <td className='p-2'>
                  <div className='text-center text-sky-500'>+429%</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                ...
                <td className='p-2'>
                  <div className='text-center text-sky-500'>+390%</div>
                </td>
              </tr>
            </tbody>
          </table>
